...
function showProjectInfo(){
   if(window.location.host.toLowerCase().indexOf("http://430designs.com/") != -1){
      //They're at http://430designs.com/rssFeed/index2.php, show them an alert.
...
function parseWeatherCondition(condition){
   ...
   if(condition == 200 || condition == 201 || condition == 202 || condition == 230 || condition == 231 || condition == 232){
      $("#weatherview .wi").addClass("wi-day-storm-showers");
      return "Thunderstorm & Rainy";
   }
   if(condition == 210 || condition == 211 || condition == 221){
      $("#weatherview .wi").addClass("wi-day-thunderstorm");
      return "Thunderstorm";
   }
   if(condition == 212){
      $("#weatherview .wi").addClass("wi-day-thunderstorm");
   ...
   if(condition == 600 || condition == 620){
      $("#weatherview .wi").addClass("wi-day-snow");
      return "Light Snow";
   }
   ...
   if(condition >= 701 && condition <= 741){
      $("#weatherview .wi").addClass("wi-day-fog");
      return "Foggy";
   }
      
   if(condition == 800){
      $("#weatherview .wi").addClass("wi-day-sunny");
      return "Clear Skies";
   }
   if(condition == 801){
      $("#weatherview .wi").addClass("wi-day-cloudy");
   ...
   if(condition == 900){
      $("#weatherview .wi").addClass("wi-tornado");
      return "Tornado";
   }
   if(condition == 901){
      $("#weatherview .wi").addClass("wi-day-sunny");
   ...
   if(condition == 905){
      $("#weatherview .wi").addClass("wi-windy");
      return "Extreme Wind";
   }
   if(condition == 906){
      $("#weatherview .wi").addClass("wi-day-hail");
      return "Extreme Hail";
   }
